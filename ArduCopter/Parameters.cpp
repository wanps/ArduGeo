...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Bitmask: 0:Allow Arming from Transmitter,1:Geometric observer,2:Ignore pilot yaw,3:SetAttitudeTarget interprets Thrust As Thrust,4:Do not stabilize PositionXY,5:Do not stabilize VelocityXY,6:Waypoint navigation used for position targets,7:Allow weathervaning
    // @User: Advanced
