...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Description: A range of options that can be applied to change auto mode behaviour. Allow Arming allows the copter to be armed in Auto. Allow Takeoff Without Raising Throttle allows takeoff without the pilot having to raise the throttle. Ignore pilot yaw overrides the pilot's yaw stick being used while in auto. Geometric motor output applies only to supported waypoint legs and also requires GEO_OUT_EN.
    // @Bitmask: 0:Allow Arming,1:Allow Takeoff Without Raising Throttle,2:Ignore pilot yaw,7:Allow weathervaning,8:Geometric motor output on supported AUTO waypoint legs
    // @User: Advanced
    ...
    // @Description: Options that can be applied to change guided mode behaviour. Geometric observer and motor output require explicit opt-in.
