...
const AP_Param::GroupInfo AC_GeometricControl::var_info[] = {
    ...
    // @Description: Maximum yaw reference rate generated by the geometric setpoint shaper when SHAPE_YAW is enabled.
    // @Range: 0 6.28
    // @Units: rad/s
    // @Increment: 0.01
    // @User: Advanced
    ...
    // @Description: Maximum yaw reference acceleration generated by the geometric setpoint shaper when SHAPE_YAW is enabled.
    // @Range: 0 20
    // @Units: rad/s/s
    // @Increment: 0.01
    // @User: Advanced
    ...
    // @Description: Enables yaw reference shaping inside the geometric setpoint shaper. This is disabled by default because Copter Guided already shapes yaw through AutoYaw before the geometric controller receives the yaw target.
    // @Values: 0:Disable,1:Enable
    // @User: Advanced
