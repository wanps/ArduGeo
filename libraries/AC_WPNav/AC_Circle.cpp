...
const AP_Param::GroupInfo AC_Circle::var_info[] = {
    ...
    // @Bitmask: 0:manual control, 1:face direction of travel, 2:Start at center rather than on perimeter, 3:Make Mount ROI the center of the circle, 8:Geometric motor output
    // @User: Standard
